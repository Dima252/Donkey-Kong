...
class Mario {
	...
	static constexpr char CorrectInput[] = { 'a', 'x', 'd', 's', 'w', 'p'};
	
	static constexpr size_t numKeys = sizeof(keys) / sizeof(keys[0]);
	static constexpr size_t numCorrectInput= sizeof(CorrectInput) / sizeof(CorrectInput[0]);
